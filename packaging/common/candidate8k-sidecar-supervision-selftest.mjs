...
must(["0.1.44-r31.alpha22.candidate8k", "0.1.46-r31.alpha23.candidate1", "0.1.46-r31.alpha23.candidate2", "0.1.46-r31.alpha23.candidate3"].includes(pkg.version), `wrong package version ${pkg.version}`);
