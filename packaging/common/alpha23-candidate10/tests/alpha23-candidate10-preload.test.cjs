...
(async () => {
  ...
  console.log("Candidate 10 actual preload: repeated-frame retention, busy bound, full canvas, frame-stage metrics, encoding errors and track-ended reporting passed");
