...
const commands = [];
const session = { id: "session-1", gamePid: 94321, launcherPid: 94316, reaperPid: null, gamescopePid: 94000 };
...
assert.match(main, /let moveKey = process\.platform === "linux" \? "Shift\+F6" : "Ctrl\+Alt\+M"/);
