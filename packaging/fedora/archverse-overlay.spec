...
Version:        0.1.47
Release:        1.r31.alpha23.candidate18%{?dist}
...
Source0:        ArchVerse-Native-0.1.47-r31.alpha23.candidate18.tar.gz
Source1:        archverse-overlay
Source2:        archverse-doctor
Source3:        archverse-overlay.desktop
Source4:        70-archverse-input.rules
...
Candidate 18 payload for KDE X11, KDE Wayland/XWayland, optional Gamescope, and held-F input.

%prep
%setup -q -n ArchVerse-Native-0.1.47-r31.alpha23.candidate18
...
%changelog
* Wed Sep 23 2026 Gavin Brooks-McCray <gbmccray32@gmail.com> - 0.1.47-1.r31.alpha23.candidate18
- Repair held-F physical keyboard authority with active-session uaccess.
