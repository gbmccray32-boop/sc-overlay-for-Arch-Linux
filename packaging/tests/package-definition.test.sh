...
PAYLOAD_SHA='244c4da008883a3bff8143078bda85c2a4f23450e11a459f2e5cc3c303483091'
...
grep -q "pkgver=0.1.47.r31.alpha23.candidate16" "$ARCH_FILE" || fail 'Arch version drift'
...
grep -q "Candidate 16 supports KDE X11 and KDE Wayland with XWayland" "$DOCTOR" || \
...
printf 'PASS: Candidate 16 package definitions are coherent and checksum-pinned\n'
